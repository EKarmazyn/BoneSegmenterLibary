function score = ScoreEvaluate(test_ct3D, dog_filt_1,dog_filt_2,pos_points,neg_points)
    ...
    for i_pp = 1:size(pos_points,1)
        ...
        good_points_scores = good_points_scores + dog_filt(cur_point_ind);
    end
    ...
    for i_pp = 1:size(neg_points,1)
        ...
        bad_points_scores = bad_points_scores + dog_filt(cur_point_ind);
    end
