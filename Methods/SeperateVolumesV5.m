function [new_labelled_map] = SeperateVolumesV5(connected_volumes,ct3D,cur_bone_model_map, X_ct, dog_gf1, dog_gf2, dog_filt_threshold, seperation_use_model_surface,  seperation_min_voxels, dilate_join_internals)
%SEPERATEVOLUMES3
