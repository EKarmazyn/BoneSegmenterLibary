function [connected_volumes_array, X_ct] = SegmentBoneV6(varargin)
...
basic_surfaces(dog_minus_smoothed_c<(1100+30)) = 0;
...
if(ss_save)
    comb = basic_surfaces;
    comb(bone_plus_surfaces==1) = 2;
     comb(new_model==1) = 3;
    SaveResults(smoothed_model, "ss1_1_"+ save_append + "_" + num2str(dataset));
end
